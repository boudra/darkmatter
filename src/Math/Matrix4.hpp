...
class Matrix4f {
   public:
    ...
    Matrix4f(float x) { this->identity(); }
    ...
    inline friend std::ostream& operator<<(std::ostream& stream,
        ...
        return stream << std::endl
                      ...
                      << ',' << std::setw(8) << m[2] << ',' << std::setw(8)
                      << m[3] << '}' << std::endl
                      << '{' << std::setw(8) << m[4] << ',' << std::setw(8)
                      << m[5] << ',' << std::setw(8) << m[6] << ','
                      << std::setw(8) << m[7] << '}' << std::endl
                      << '{' << std::setw(8) << m[8] << ',' << std::setw(8)
                      << m[9] << ',' << std::setw(8) << m[10] << ','
                      << std::setw(8) << m[11] << '}' << std::endl
