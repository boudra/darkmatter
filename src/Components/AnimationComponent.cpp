...
namespace dm {
  ...
  size_t AnimationComponent::animate(const std::string& name, const float speed, const bool loop,
				     std::function<void(Entity*)> callback)
  {
    size_t animation_id = s_animations->start_animation(name, speed, loop, callback);
