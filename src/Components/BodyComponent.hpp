...
const Vec3f TILE_SIZE{32.0f / 1280.0f, 32.0f / 1280.0f, 32.0f / 1280.0f};

struct Command {
    enum class Type { MOVE_LEFT, MOVE_RIGHT, MOVE_UP, MOVE_DOWN, GO_TO };
...
enum class TileType { TERRAIN, WALL };
